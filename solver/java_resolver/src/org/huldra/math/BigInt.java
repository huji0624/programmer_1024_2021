...
public class BigInt extends Number implements Comparable<BigInt> {
     ...
     * @complexity O(n ^ 2)
     */
    public BigInt(final char[] s, final int slen) {
        assign(s, slen);
    }
    /*** </Constructors> ***/
     ...
     * @complexity O(n ^ 2)
     */
    public void assign(final char[] s, final int slen) {
        sign = s[0] == '-' ? -1 : 1;
     ...
     * @complexity O(n)
     */
    public BigInt sub(final BigInt a) //Fix naming.
    {
        if (sign != a.sign) {
            addMag(a.dig, a.len);
            return this;
